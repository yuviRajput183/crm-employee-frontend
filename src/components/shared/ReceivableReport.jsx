...
import { apiGetReceivablesReport } from '@/services/reports.api';
...
const ReceivableReport = () => {
    ...
    const {
        ...
        queryKey: ['receivables-report', filterParams],
        queryFn: async () => {
            const res = await apiGetReceivablesReport(filterParams);
        ...
        <div className=' p-3 bg-white rounded shadow min-h-screen'>
            ...
            <div className=' flex justify-between items-center pb-2 border-b-2 '>
                <div className=' flex items-center gap-2'>
                    ...
                    <h1 className=' text-2xl font-bold text-gray-700'>Receivable Report</h1>
                </div>
                <Button
                ...
                <Table className="min-w-[1500px]">
                    ...
                    <TableBody>
                        {isLoading ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={19} className="text-center py-10 text-gray-500">No receivable records found.</TableCell>
                            </TableRow>
                        )}
                        {reportData?.totals && reportData?.data?.length > 0 && (
                            <TableRow className="bg-[#f39c12] hover:bg-[#e67e22] transition-colors border-b">
                                ...
                                <TableCell className="text-xs py-2 border-r text-white" colSpan={6}></TableCell>
