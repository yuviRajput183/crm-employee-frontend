...
import { apiGetGSTPayablesReport } from '@/services/reports.api';
import { getErrorMessage } from '@/lib/helpers/get-message';
import { Alert } from '@/components/ui/alert';
import { useForm } from 'react-hook-form';
import ReportsFilterSection from './ReportsFilterSection';

const GSTPayableReport = () => {
    ...
    const {
        ...
        queryKey: ['gst-payables-report', filterParams],
        queryFn: async () => {
            const res = await apiGetGSTPayablesReport(filterParams);
        ...
        <div className=' p-3 bg-white rounded shadow min-h-screen'>
            ...
            <div className=' flex justify-between items-center pb-2 border-b-2 '>
                <div className=' flex items-center gap-2'>
                    ...
                    <h1 className=' text-2xl font-bold text-gray-700'>GST Payable Report</h1>
                </div>
                <Button
            ...
            <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 hover:scrollbar-thumb-gray-500 w-full p-2 shadow border border-gray-100 rounded-md mt-4 max-h-[70vh] overflow-y-auto">
                <Table className="min-w-[1600px]">
                    ...
                    <TableBody>
                        {isLoading ? (
                            <TableRow>
                                <TableCell colSpan={17} className="text-center py-10">Loading report data...</TableCell>
                            </TableRow>
