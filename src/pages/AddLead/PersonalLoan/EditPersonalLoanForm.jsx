...
const personalLoanSchema = z.object({
    ...
    // Optional with validation if filled
...
const EditPersonalLoanForm = () => {
    ...
    const handlePersonalLoan = async (data) => {
        ...
        try {
            ...
            fd.append('productType', 'Personal Loan');
            ...
            console.log('✅ Personal Loan lead updated successfully:', res);
...
export default EditPersonalLoanForm
