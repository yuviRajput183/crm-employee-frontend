    ...
    useEffect(() => {
        ...
        if (leadData?.data) {
            ...
            form.reset({
                ...
                fuelType: lead?.fuelType || undefined,
            ...
            <Form {...form}>
                ...
                >
                    ...
                    {(() => {
                        ...
                        return <Button loading={isLoading} onClick={() => console.log("clicked")} type="submit" className="bg-blue-800 text-white mt-4 ">SAVE</Button>;
                    })()}
...
export default EditUsedCarLoanForm;
